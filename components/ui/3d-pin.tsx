  ...
  return (
    <motion.div className="pointer-events-none  w-full h-60 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute -top-12 -left-40 inset-x-0 flex w-80 justify-center">
          <div className="relative flex space-x-2 items-center z-10 w-60 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 ">
